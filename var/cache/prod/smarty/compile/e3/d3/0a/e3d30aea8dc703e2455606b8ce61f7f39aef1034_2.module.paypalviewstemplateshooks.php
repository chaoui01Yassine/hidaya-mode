...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5e39e110dee721_33263451',
...
function content_5e39e110dee721_33263451 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
" method="post" data-ajax="false">
        <?php if ($_smarty_tpl->tpl_vars['source_page']->value == 'product') {?>
          <input
                  ...
                  value="<?php if (isset($_GET['id_product'])) {
echo htmlspecialchars(intval($_GET['id_product']), ENT_QUOTES, 'UTF-8');
}?>" />
