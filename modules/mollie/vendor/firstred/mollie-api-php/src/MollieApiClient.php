...
use Mollie\Api\Http\Client;
use Mollie\Api\Http\ClientInterface;
...
class MollieApiClient
{
    ...
    public function performHttpCallToFullUrl($httpMethod, $url, $httpBody = null)
    {
        ...
        $headers = array('Accept' => "application/json", 'Authorization' => "Bearer {$this->apiKey}", 'User-Agent' => $userAgent);
        ...
        try {
            ...
            throw ApiException::createFromRequestException($e);
        }
    ...
    {
        // Initialize client
        $this->httpClient = is_object($httpClient) ? $httpClient : new Client();

        // Check compatibility before using the client
        ...
        // Initialize the User-Agent header
        $this->addVersionString("Mollie/".self::CLIENT_VERSION);
        $this->addVersionString("PHP/".phpversion());
        $this->addVersionString("PHPCurlClass/".Client::VERSION);
    }
