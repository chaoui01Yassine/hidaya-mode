...
class MethodEndpoint extends EndpointAbstract
{
     ...
     *
     * @return \Mollie\Api\Resources\BaseResource|Method
     * @throws ApiException
     */
    public function get($methodId, array $parameters = array())
    {
        if (empty($methodId)) {
     ...
     * @param array $parameters
     *
     * @return \Mollie\Api\Resources\BaseCollection|MethodCollection
     * @throws ApiException
     */
