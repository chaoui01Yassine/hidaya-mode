...
class ProfileMethodEndpoint extends EndpointAbstract
{
     ...
     */
    public function createForId($profileId, $methodId, array $data = array())
    {
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public function createFor($profile, $methodId, array $data = array())
    {
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public function createForCurrentProfile($methodId, array $data = array())
    {
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public function deleteForId($profileId, $methodId, array $data = array())
    {
        $this->parentId = $profileId;
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public function deleteFor($profile, $methodId, array $data = array())
    {
