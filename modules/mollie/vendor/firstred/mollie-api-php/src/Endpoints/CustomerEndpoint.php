...
class CustomerEndpoint extends EndpointAbstract
{
     ...
     * @param array $filters
     *
     * @return \Mollie\Api\Resources\BaseResource|Customer
     * @throws ApiException
     */
     ...
     * @throws ApiException
     */
    public function get($customerId, array $parameters = array())
    {
     ...
     * @throws ApiException
     */
    public function delete($customerId, array $data = array())
    {
     ...
     * @param array  $parameters
     *
     * @return \Mollie\Api\Resources\BaseCollection|CustomerCollection
     * @throws ApiException
     */
