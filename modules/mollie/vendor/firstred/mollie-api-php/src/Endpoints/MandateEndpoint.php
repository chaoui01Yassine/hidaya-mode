...
class MandateEndpoint extends EndpointAbstract
{
     ...
     */
    public function createFor(Customer $customer, array $options = array(), array $filters = array())
    {
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public function createForId($customerId, array $options = array(), array $filters = array())
    {
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public function getFor(Customer $customer, $mandateId, array $parameters = array())
    {
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public function getForId($customerId, $mandateId, array $parameters = array())
    {
        $this->parentId = $customerId;
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public function listFor(Customer $customer, $from = null, $limit = null, array $parameters = array())
    {
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public function listForId($customerId, $from = null, $limit = null, array $parameters = array())
    {
        $this->parentId = $customerId;
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public function revokeFor(Customer $customer, $mandateId, $data = array())
    {
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public function revokeForId($customerId, $mandateId, $data = array())
    {
        $this->parentId = $customerId;
