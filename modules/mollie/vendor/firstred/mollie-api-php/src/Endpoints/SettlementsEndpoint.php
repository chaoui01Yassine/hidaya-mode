...
class SettlementsEndpoint extends EndpointAbstract
{
     ...
     *
     * @return BaseResource|Settlement
     * @throws ApiException
     */
    public function get($settlementId, array $parameters = array())
    {
    ...
    {
        return parent::rest_read("next", array());
    }
    ...
    {
        return parent::rest_read("open", array());
    }
     ...
     * @param array  $parameters
     *
     * @return BaseCollection|SettlementCollection
     * @throws ApiException
     */
