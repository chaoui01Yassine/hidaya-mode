...
abstract class EndpointAbstract
{
     ...
     * @throws ApiException
     */
    protected function rest_delete($id, array $body = array())
    {
        if (empty($id)) {
            throw new ApiException("Invalid resource id.");
        }
     ...
     * @throws ApiException
     */
    protected function rest_list($from = null, $limit = null, array $filters = array())
    {
        $filters = \array_merge(array('from' => $from, 'limit' => $limit), $filters);
