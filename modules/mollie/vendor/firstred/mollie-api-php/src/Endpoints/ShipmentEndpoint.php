...
class ShipmentEndpoint extends EndpointAbstract
{
     ...
     */
    public function createFor(Order $order, array $options = array(), array $filters = array())
    {
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public function createForId($orderId, array $options = array(), array $filters = array())
    {
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public function getFor(Order $order, $shipmentId, array $parameters = array())
    {
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public function getForId($orderId, $shipmentId, array $parameters = array())
    {
        $this->parentId = $orderId;
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public function listFor(Order $order, array $parameters = array())
    {
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public function listForId($orderId, array $parameters = array())
    {
        $this->parentId = $orderId;
