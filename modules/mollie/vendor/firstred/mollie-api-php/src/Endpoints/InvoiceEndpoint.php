...
class InvoiceEndpoint extends EndpointAbstract
{
     ...
     *
     * @return \Mollie\Api\Resources\BaseResource|Invoice
     * @throws ApiException
     */
    public function get($invoiceId, array $parameters = array())
    {
     ...
     * @param array  $parameters
     *
     * @return \Mollie\Api\Resources\BaseCollection|InvoiceCollection
     * @throws ApiException
     */
