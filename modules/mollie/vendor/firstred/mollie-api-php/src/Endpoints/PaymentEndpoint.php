...
class PaymentEndpoint extends EndpointAbstract
{
     ...
     * @throws ApiException
     */
    public function get($paymentId, array $parameters = array())
    {
     ...
     * @throws ApiException
     */
    public function delete($paymentId, array $data = array())
    {
     ...
     * @throws ApiException
     */
    public function cancel($paymentId, array $data = array())
    {
        return $this->rest_delete($paymentId, $data);
    }
